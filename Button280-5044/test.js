...
class Button_385 extends Component {
render() {return (
<div className={styles.Button_385}><div className={styles._Button___Element___Base_Default_679}><div className={styles.icon_left_689}><div className={styles.favorite_393}><div className={styles.Frame_209}></div></div></div><div className={styles.text_985}><div className={styles._Button___Element___Label_769}><p className={styles.text_35}>Button</p>
</div></div><div className={styles.icon_right_270}><div className={styles.arrow_forward_12}><div className={styles.Frame_77}><div className={styles.Vector_499}><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
