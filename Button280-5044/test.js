...
class Button_865 extends Component {
render() {return (
<div className={styles.Button_865}><div className={styles._Button___Element___Base_Default_8}><div className={styles.icon_left_686}><div className={styles.favorite_424}><div className={styles.Frame_816}></div></div></div><div className={styles.text_617}><div className={styles._Button___Element___Label_83}><p className={styles.text_706}>Button</p>
</div></div><div className={styles.icon_right_48}><div className={styles.arrow_forward_112}><div className={styles.Frame_942}><div className={styles.Vector_757}><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
