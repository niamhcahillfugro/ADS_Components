...
class Button_721 extends Component {
render() {return (
<div className={styles.Button_721}><div className={styles._Button___Element___Base_Default_45}><div className={styles.icon_left_790}><div className={styles.favorite_337}><div className={styles.Frame_540}></div></div></div><div className={styles.text_982}><div className={styles._Button___Element___Label_367}><p className={styles.text_45}>Button</p>
</div></div><div className={styles.icon_right_613}><div className={styles.arrow_forward_918}><div className={styles.Frame_744}><div className={styles.Vector_964}><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
