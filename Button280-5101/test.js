...
class Button_581 extends Component {
render() {return (
<div className={styles.Button_581}><div className={styles._Button___Element___Base_Default_556}><div className={styles.icon_left_327}><div className={styles.favorite_685}><div className={styles.Frame_983}>undefined</div></div></div><div className={styles.text_889}><div className={styles._Button___Element___Label_103}><p className={styles.text_945}>Button</p>
</div></div><div className={styles.icon_right_521}><div className={styles.arrow_forward_183}><div className={styles.Frame_661}><div className={styles.Vector_457}><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
